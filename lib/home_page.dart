      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Color.fromARGB(255 ,214, 196, 242), Color.fromARGB(255, 178, 141, 255), Color.fromARGB(255, 138, 77, 255)],
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration( 
                                          ...
                                          border: OutlineInputBorder(
                                            borderRadius: BorderRadius.circular(4.0), // Adjust value for more/less curve
